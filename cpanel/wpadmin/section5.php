...
if (isset($_GET['action']) && $_GET['action'] === 'submit') {
    ...
    $g_name4 = $db->CleanDBData($_POST['g_name4']);
    ...
    $g_img_old4 = $db->CleanDBData($_POST['g_img_old4']);
    ...
    if ($_FILES["g_img4"]["tmp_name"]) {
        $target_dir = '../../upload/section/';
        $filename = uniqid() . "-" . time(); // 5dab1961e93a7-1571494241
        $extension = pathinfo($_FILES["g_img4"]["name"], PATHINFO_EXTENSION); // jpg
        $basename = $filename . "." . $extension; // 5dab1961e93a7_1571494241.jpg

        $source = $_FILES["g_img4"]["tmp_name"];
        $destination = $target_dir . $basename;
    ...
    $sqlu2 = "update section5 set g_title=?,g_name=?,g_name2=?,g_name3=?,g_name4=?,g_img=?,g_img2=?,g_img3=?,g_img4=?, g_background=? where sid=?";
    $values2 = array($g_title, $g_name, $g_name2, $g_name3, $g_name4, $imgCon, $imgCon2, $imgCon3, $imgCon4, $imgBackground, $sid);
    $model->doUpdate($sqlu2, $values2);

    header("Location:section5.php");

} else {
    $RecDataSQL = "SELECT * FROM section5 WHERE `sid` = ? LIMIT 1";
  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper site-min-height">
        <h3><i class="fa fa-angle-right"></i> Content Section 5</h3>
        <div class="row mt">
          <div class="col-lg-12">
          <div class="form-panel">
              <form class="form-horizontal style-form" method="post" action="section5.php?action=submit" enctype="multipart/form-data">
...
?>
                ...
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Images 01<br>(300px X 300px)</label>
                  <div class="col-sm-10">
...
?>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label">Images Name 01</label>
                  <div class="col-sm-9">
                    <input type="text" class="form-control" name="g_name" value="<?php echo $RecData[0]['g_name']; ?>">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Images 02 <br>(300px X 300px)</label>
                  <div class="col-sm-10">
...
?>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label">Images Name 02</label>
                  <div class="col-sm-9">
                    <input type="text" class="form-control" name="g_name2" value="<?php echo $RecData[0]['g_name2']; ?>">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Images 03 <br>(300px X 300px)</label>
                  <div class="col-sm-10">
...
?>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label">Images Name 03</label>
                  <div class="col-sm-9">
                    <input type="text" class="form-control" name="g_name3" value="<?php echo $RecData[0]['g_name3']; ?>">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Images 04<br>(300px X 300px)</label>
                  <div class="col-sm-10">
                    <input name="g_img4" type="file" class="form-control">
                    <input name="g_img_old4" type="hidden" class="form-control" value="<?php echo $RecData[0]['g_img4']; ?>">
                    <?php
if ($RecData[0]['g_img4']) {?>
                        <br><a href="../../upload/section/<?php echo $RecData[0]['g_img4']; ?>" target='_blank'><img src="../../upload/section/<?php echo $RecData[0]['g_img4']; ?>" height="150" style="background-color: #ddd;"></a>
                        <?php
}
?>
                  </div>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label">Images Name 04</label>
                  <div class="col-sm-9">
                    <input type="text" class="form-control" name="g_name4" value="<?php echo $RecData[0]['g_name4']; ?>">
                  </div>
                </div>
                <div class="form-group">
