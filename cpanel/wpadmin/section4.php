...
if (isset($_GET['action']) && $_GET['action'] === 'submit') {
    ...
    $RecDataSQL = "SELECT * FROM section4 WHERE `sid` = ? LIMIT 1";
  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper site-min-height">
        <h3><i class="fa fa-angle-right"></i> Content Section 4</h3>
        <div class="row mt">
          <div class="col-lg-12">
          <div class="form-panel">
              <form class="form-horizontal style-form" method="post" action="section4.php?action=submit" enctype="multipart/form-data">
...
?>
                ...
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Images <br>(300px X 500px)</label>
                  <div class="col-sm-10">
...
?>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label">Images Link</label>
                  <div class="col-sm-9">
