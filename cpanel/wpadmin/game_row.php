...
if (isset($_GET['action']) && $_GET['action'] === 'delete') {
    ...
    $sqli = "DELETE FROM `game_row` WHERE `id` = ?";
    $values = array($_GET['id']);
    $model->doDelete($sqli, $values);
    unlink('../../upload/game/' . $_GET['img']);
  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> Game Row</h3>
        <div><a href="game_row_add.php"><button class="btn btn-primary">Add Game Row</button></a></div></div><br>
        <div class="row mb">
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel">Delete Game Row</h4>
          </div>
  ...
  function deleteGame(id,name,img){
    ...
    $(document).ready(function() {
      ...
      $( ".udelBt" ).click(function() {
        ...
        window.location.href = 'game_row.php?action=delete&id='+id+'&img='+img;
      });
      ...
      var dataTable = $('#hidden-table-info').DataTable( {
          ...
          "iDisplayLength": 25,
					"ajax":{
						url :"game_row_ajax.php", // json datasource
