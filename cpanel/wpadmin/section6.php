...
if (isset($_GET['action']) && $_GET['action'] === 'submit') {
    ...
    $sqlu2 = "update section6 set g_title=?,g_img=?, g_background=? where sid=?";
    $values2 = array($g_title, $imgCon, $imgBackground, $sid);
    $model->doUpdate($sqlu2, $values2);

    header("Location:section6.php");

} else {
    $RecDataSQL = "SELECT * FROM section6 WHERE `sid` = ? LIMIT 1";
  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper site-min-height">
        <h3><i class="fa fa-angle-right"></i> Content Section 6</h3>
        <div class="row mt">
          <div class="col-lg-12">
          <div class="form-panel">
              <form class="form-horizontal style-form" method="post" action="section6.php?action=submit" enctype="multipart/form-data">
...
?>
                ...
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Images <br>(700px X 400px)</label>
                  <div class="col-sm-10">
